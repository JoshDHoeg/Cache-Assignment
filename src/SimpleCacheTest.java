...
public class SimpleCacheTest
{
	...
	{	s_currentMethod = new Object(){}.getClass().getEnclosingMethod().getName();
		...
		ReadOnlyCache cache = new /*Solution*/Cache(memory, 2, 4, 1); // direct mapped cache
	...
	{	s_currentMethod = new Object(){}.getClass().getEnclosingMethod().getName();
		...
		ReadOnlyCache cache = new /*Solution*/Cache(memory, 4, 4, 2);
		checkEqual(0, memory.getReadCalls(), "checking zero reads from memory initially.");
	...
	{	s_currentMethod = new Object(){}.getClass().getEnclosingMethod().getName();
		...
		ReadOnlyCache cache = new /*Solution*/Cache(memory, 2, 4, 2);
		checkEqual(0, memory.getReadCalls(), "checking zero reads from memory initially.");
